      ...
      <div class="card-body">
        <form @submit.prevent="guardarCliente">
          <div class="grid grid-cols-2">
            ...
            <small v-if="cliente.errores.correoElectronico" class="text-danger">
                {{ cliente.errores.correoElectronico }}
              </small>
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-primary" :disabled="guardando">
              <span v-if="!guardando">Guardar Cliente</span>
...
export default {
  ...
  methods: {
    async guardarCliente() {
      try {
        this.guardando = true
        await apiService.crearCliente(this.cliente)
        ...
        this.cliente.errores = respuesta?.errors || {}
...
.crear-cliente-container { max-width: 960px; }
